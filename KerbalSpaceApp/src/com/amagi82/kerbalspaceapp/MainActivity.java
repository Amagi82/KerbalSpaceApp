...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dataList.add(new NavigationDrawerItem("Utilities")); // adding a header to the list
		dataList.add(new NavigationDrawerItem("Mission Planner", R.drawable.ic_action_event));
		// dataList.add(new NavigationDrawerItem("Aerocapture Calculator", R.drawable.ic_action_cloud)); - not implemented yet
		dataList.add(new NavigationDrawerItem("Settings", R.drawable.ic_action_settings));

		dataList.add(new NavigationDrawerItem("")); // adding a header to the list
		dataList.add(new NavigationDrawerItem("Feedback", R.drawable.ic_action_paste));
		dataList.add(new NavigationDrawerItem("About", R.drawable.ic_action_about));
